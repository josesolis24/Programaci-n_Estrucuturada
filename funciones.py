...
"""
  ...
  como un programa mas pequeño que cumple una funcion especifica. La funcion se puede
  reutulizar con el simple hecho de invocarla es decir mandarla llamar Sintaxis:
...
#Mandar llamar o invocarmlas funciones 
solicitarDatos1()
...
telefono=input("Escribir el telefono:")
